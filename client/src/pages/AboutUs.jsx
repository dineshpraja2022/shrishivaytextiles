...
>
      ...
      <section className="max-w-6xl mx-auto px-6 py-20 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <p className="text-sm text-blue-600 uppercase font-semibold tracking-widest mb-3">
            About Us
          </p>
          <h2 className="text-3xl sm:text-4xl  leading-tight mb-6 ">
            Meet the Heart of <span className="text-blue-500">Our Company</span>
          </h2>
          <div className="space-y-5 text-[17px] text-gray-700 leading-[1.8] text-justify font-light">
            <p><strong className="text-blue-600 font-medium">Shri Shivay Textiles</strong> is more than a brand — it's a story of dedication, passion, and human craftsmanship.</p>
          ...
          For over 5 years, we’ve been handcrafting premium-quality ropes and accessories like <strong>horse ropes, dog leashes, halters, and animal leads</strong>.
            ...
            <p>Every item tells a story and every rope carries the promise of <strong className="text-blue-600">trust, love, and long-lasting quality</strong>.</p>
          </div>
        </motion.div>
      </section>
